...
<form action="index.php" method="post">
  <?php include 'Ajuda/ajuda_curso_adm.php' ?>
...
<div class="panel panel-primary">
    <div STYLE="background-color:GreenYellow" class="panel panel-default"><h2 STYLE="text-align:center;"><I>INSERIR INFORMAÇÕES PARA O CURSO</I></h2></div>
...
<div class="form-group">
  <label class="col-md-2 control-label" for="Nome">Nome do Professor do curso<h11>*</h11></label>  
  <div class="col-md-8">
...
<div class="form-group">
  <label class="col-md-2 control-label" for="prependedtext">Telefone da Cordenação do Cuso<h11>*</h11></label>
  <div class="col-md-2">
    <div class="input-group">
...
<div class="form-group">
  ...
  <label class="col-md-2 control-label" for="selectbasic">Selecione o Campus que vai Oferecer o Curso <h11>*</h11></label>
