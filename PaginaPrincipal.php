...
<div class="col-md-11 control-label">
  ...
  <div STYLE="background-color:GreenYellow" class="panel panel-default">
  <fieldset>
  <div>
  <fieldset>
...
<h2 STYLE="font-size:25px;text-align:center"><FONT color="black">Endereço: Acopiara - CE  &nbsp &nbsp CEP: 63560-000</h2>
</div>
<a href="register.php"><h2 style="text-align:center;font-size:25px"><input type="button" value="Cadastre-se"/></h2></a>
</fieldset>
