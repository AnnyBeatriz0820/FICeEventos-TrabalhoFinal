<!DOCTYPE html>
<html lang='en'>
  <?php include 'Ajuda/ajuda_evento_adm.php' ?>
...
<div class="panel panel-primary">
    <div STYLE="background-color:GreenYellow" class="panel panel-default"><h2 STYLE="text-align:center;"><I>INSERIR INFORMAÇÕES PARA O EVENTO</I></h2></div>
...
<div class="form-group">
  <label class="col-md-2 control-label" for="Nome">Nome do Evento<h11>*</h11></label>  
  <div class="col-md-8">
...
<div class="form-group">
  ...
  <label class="col-md-1 control-label" for="Nome">Data do Evento<h11>*</h11></label>  
  <div class="col-md-2">
...
<!-- Prepended text-->
<div class="form-group">
  <label class="col-md-2 control-label" for="prependedtext">Email para dúvidas sobre o Evento<h11>*</h11></label>
  <div class="col-md-5">
    <div class="input-group">
...
<div class="form-group">
  ...
  <div class="col-md-8">
    <button id="Cadastrar" name="Cadastrar" class="btn btn-success" type="Submit">Oferecer Evento</button>
    <button id="Cancelar" name="Cancelar" class="btn btn-danger" type="Reset">Cancelar</button>
  </div>
</div>
</fieldset>
</form>
   </div>       <!-- FIM PARTE PRINCIPAL DA PAGINA ONDE DEVE SER ADICIONADO O CONTEUDO-->
