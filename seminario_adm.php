...
<div class="panel panel-primary">
    <div STYLE="background-color:GreenYellow" class="panel panel-default"><h2 STYLE="text-align:center;"><I>INSERIR INFORMAÇÕES PARA O SEMINÁRIO</I></h2></div>
...
<div class="form-group">
  ...
  <fieldset>
  <label class="col-md-1 control-label" for="Nome">Data do Seminário<h11>*</h11></label>  
  <div class="col-md-2">
...
<div class="form-group">
  ...
  <label class="col-md-2 control-label" for="selectbasic">Selecione o Campus que vai Realizar o Seminário <h11>*</h11></label>
    <div class="col-md-3">
...
<div class="form-group">
  ...
  <div class="col-md-8">
    <button id="Cadastrar" name="Cadastrar" class="btn btn-success" type="Submit">Oferecer Seminário</button>
