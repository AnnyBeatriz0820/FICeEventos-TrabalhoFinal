      ...
      <div class="modal-dialog">
        ...
        <div class="modal-content">
          ...
          <div class="modal-header">
            <h4 class="modal-title">Pronto (a) para se inscrever no curso fic?</h4>
          ...
          <div class="modal-body">
            ...
            6º Escolha seu estado e o tema do curso fic na setinha ao lado;
             </br>
            7º clique em Inscrever;
             </br>
             8º Caso der erro prencha os todos os campus obrigatórios  com outras informações requisitada e repita o 7º procedimento até obter sucesso.</p>
          </div>
