        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
           <p style="color:red";>
            ...
            <p>1º Descreva a Palestra que deseja participar.</p>
            <p>2º Clique em Inscrever.</p>
            <p style="color:green";>
          Após seguir os passos descritos acima, sua inscrição será realizada com sucesso!
        </p>
          </div>
